...
public class Stream_01_Test {
    ...
    public void test_stream_filter_and_match() throws Exception {
        ...
        List<Order> result = orders.stream().filter(o -> o.getCustomer().getFirstname() == "Johnny")  		
    ...
    public void test_stream_max() throws Exception {
        ...
        Optional<Pizza> result = pizzas.stream().filter(p -> max(p.getPrice())).collect(Collectors.toList());
    ...
    public void test_stream_min() throws Exception {
        ...
        Optional<Pizza> result = pizzas.stream().filter(p -> min (p.getPrice() >= 950))
        .collect(Collectors.toList());
